...
export const messages: Record<Locale, Record<MessageKey, string>> = {
  en: {
    ...
    symbolsHint: 'Leave blank to let the system scan default tickers for the selected markets. Or use symbols such as AAPL, 0700.HK, D05.SI, 2330.TW, 600519.SS.',
  ...
  'zh-CN': {
    ...
    symbols: '股票代码清单',
    symbolsHint: '留空时系统会自动扫描所选市场的默认股票；也可以输入 AAPL、0700.HK、D05.SI、2330.TW、600519.SS 等代码。',
  ...
  'zh-TW': {
    ...
    symbols: '股票代碼清單',
    symbolsHint: '留空時系統會自動掃描所選市場的預設股票；也可以輸入 AAPL、0700.HK、D05.SI、2330.TW、600519.SS 等代碼。',
