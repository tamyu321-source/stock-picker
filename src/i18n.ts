...
export const messages: Record<Locale, Record<MessageKey, string>> = {
  en: {
    ...
    symbolsHint: 'Leave blank to scan selected markets from local finance news sources. Or use symbols such as AAPL, 0700.HK, D05.SI, 2330.TW, 600519.SS.',
  ...
  'zh-CN': {
    ...
    symbols: '股票代码清单',
    symbolsHint: '留空时系统会优先从所选市场的当地财经新闻源自动扫描；也可以输入 AAPL、0700.HK、D05.SI、2330.TW、600519.SS 等代码。',
  ...
  'zh-TW': {
    ...
    symbols: '股票代碼清單',
    symbolsHint: '留空時系統會優先從所選市場的當地財經新聞源自動掃描；也可以輸入 AAPL、0700.HK、D05.SI、2330.TW、600519.SS 等代碼。',
